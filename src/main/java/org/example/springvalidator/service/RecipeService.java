...
import org.example.springvalidator.mapper.RecipeMapper;
import org.example.springvalidator.model.dto.RecipeDTO;
import org.example.springvalidator.model.entity.Recipe;
import org.example.springvalidator.repository.RecipeRepository;
...
public class RecipeService implements IRecipeService {
    ...
    public List<RecipeDTO> getAllRecipes(){
        return recipeRepository
                .findAll()
                .stream()
                .map(r -> recipeMapper.recipeToRecipeDTO(r))
                .toList();
    }
